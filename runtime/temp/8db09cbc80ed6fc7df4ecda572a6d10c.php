<?php /*a:1:{s:77:"D:\phpStudy\PHPTutorial\WWW\hvvv\application\admin\view\statistics\order.html";i:1653485808;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-form layui-card-header layuiadmin-card-header-auto">
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    <label class="layui-form-label">四方标识</label>
...
<script>
    ...
    function renderTable() {
        layTool.table("#LAY-user-table", "/admin/statistics/order", [
            [{
                field: "amount",
                title: "金额",
            }, {
