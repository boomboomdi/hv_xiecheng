<?php /*a:1:{s:76:"D:\phpStudy\PHPTutorial\WWW\dvpay\application\admin\view\merchant\index.html";i:1641576453;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-card">
        <div class="layui-form layui-card-header layuiadmin-card-header-auto">
            <div class="layui-form-item">
                ...
                <!--                    <div class="layui-input-block">-->
                <!--                        <input type="text" name="merchant_sign" placeholder="请输入" autocomplete="off" class="layui-input">-->
                <!--                    </div>-->
                <!--                </div>-->
                <div class="layui-inline">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="table-seller-admin">
                ...
                <?php endif; if((buttonAuth('merchant/editmerchant'))): ?>
                    ...
                    if ("del" === e.event) {
                        ...
                        layer.ready(function () {
                            var index = layer.confirm('您确定要删除该商户？', {
                                ...
                                $.getJSON('<?php echo url("merchant/delMerchant"); ?>', {id: e.data.merchant_id}, function (res) {
