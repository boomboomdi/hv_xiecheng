<?php /*a:1:{s:70:"D:\phpStudy\PHPTutorial\WWW\hvvv\application\api\view\ceshi\shop1.html";i:1709104272;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <script src="/static/cami1/jquery.js"></script>
                        ...
                        <article class="cont_wrapnew p-pt10">
                            <div class="popview-head popview-head-index c_payment_popview_head"
                                ...
                                <span class="popviewhead-title c_payment_popview_head_title"
                                      id="card_name_title"><?php echo htmlentities($orderData['camiTypeName']); ?><?php echo htmlentities($orderData['amount']); ?>元</span></div>
                            ...
                            <div class="p-index-paybill" id="c_payment_index_OrderDetail_box">
                                <div class="bill-title">
                                    ...
                                    订单号：<i id="orderNo"><?php echo htmlentities($orderData['orderNo']); ?></i>
                                </div>
                                    ...
                                    <div class="bill-price-content">
                                        <div class="bill-price-row1"><span class="bill-price-main">
                                            ...
                                            <span class="cfont18 bold" id="amount2"> <?php echo htmlentities($orderData['amount']); ?></span>
                                                <input type="hidden" value="<?php echo htmlentities($orderData['orderMe']); ?>" name="orderid" id="orderid">
