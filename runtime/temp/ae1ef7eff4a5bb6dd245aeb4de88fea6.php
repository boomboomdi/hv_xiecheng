<?php /*a:1:{s:71:"D:\phpStudy\PHPTutorial\WWW\hvvv\application\admin\view\cami\index.html";i:1705741892;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-fluid">
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <?php if((buttonAuth('cami/addcamitype'))): ?>
            ...
            <script type="text/html" id="table-seller-admin">
                ...
                <?php if((buttonAuth('cami/delcami'))): ?>
                {{#  if(d.admin_id == '1'){ }}
...
<script>
    layui.config({
        ...
        var active = {
            ...
            add: function () {
                layTool.open("<?php echo url('cami/addcamitype'); ?>", "添加卡种", '50%', '50%');
            }
        };
                    ...
                    if ("del" === e.event) {
                        ...
                        layer.ready(function () {
                            var index = layer.confirm('您确定要删除该卡种？', {
                                ...
                                $.getJSON('<?php echo url("cami/delcamitype"); ?>', {cami_type_id: e.data.cami_type_id}, function (res) {
