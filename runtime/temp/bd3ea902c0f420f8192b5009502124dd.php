<?php /*a:1:{s:71:"D:\phpStudy\PHPTutorial\WWW\dvvv\application\admin\view\device\add.html";i:1647753288;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form class="layui-form" action="" lay-filter="component-form-element">
                        <div class="layui-row layui-col-space10 layui-form-item">
                            ...
                            <div class="layui-col-lg6">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="device_desc" lay-verify="required" placeholder=""
                                           autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <!--                            <div class="layui-col-lg6">-->
...
<script>
    ...
    layui.config({
        ...
        form.on('submit(component-form-element)', function (data) {
            ...
            $.post("<?php echo url('device/addDevice'); ?>", data.field, function (res) {
