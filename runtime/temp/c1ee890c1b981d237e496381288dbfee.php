<?php /*a:1:{s:74:"D:\phpStudy\PHPTutorial\WWW\hvvv\application\admin\view\writeoff\edit.html";i:1705825337;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="layui-row layui-col-space10 layui-form-item">
                            ...
                            <div class="layui-col-lg6">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="merhant_id" lay-verify="required"
                                           value="<?php echo htmlentities($writeOff['merhant_id']); ?>"
                            ...
                            <div class="layui-col-lg6">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="secret_key" lay-verify="required" placeholder=""
                                           autocomplete="off" class="layui-input" value="<?php echo htmlentities($writeOff['secret_key']); ?>">
                                </div>
                            </div>
                            <div class="layui-col-lg6">
                            ...
                            <div class="layui-col-lg6">
                                ...
                                <div class="layui-input-block">
                                    ...
                                    checked <?php endif; ?>>
                                    <input type="radio" name="status" value="2" title="禁用" <?php if($writeOff['status'] == 2): ?>
                                    checked <?php endif; ?>>
                                </div>
                            </div>
