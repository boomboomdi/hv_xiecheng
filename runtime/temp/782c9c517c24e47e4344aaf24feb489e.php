<?php /*a:1:{s:72:"D:\phpStudy\PHPTutorial\WWW\hvvv\application\admin\view\index\index.html";i:1653485808;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-header header">
        <div class="layui-logo">
            <a href="">
                ...
                <h1><?php echo htmlentities($node_title); ?></h1>
            </a>
        </div>
        <a>
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item layuimini-setting">
                <a href="javascript:;">
                    <?php if(!empty($menu)): ?>
                        <?php echo htmlentities($admin_user_name); ?>
                    <?php endif; ?>
                </a>
