<?php /*a:1:{s:69:"D:\phpStudy\PHPTutorial\WWW\hvvv\application\api\view\ceshi\kami.html";i:1705841966;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <script src="./jwzckjs/jquery.js"></script>
    <link rel="stylesheet" href="./jwzckjs/n_main.css">
    <link rel="stylesheet" href="./jwzckjs/pay.css">
    <script type="text/javascript" src="./jwzckjs/layer.js"></script>
    <link rel="stylesheet" href="./jwzckjs/layer.css" id="layuicss-layer">
                        ...
                        <article class="cont_wrapnew p-pt10">
                                ...
                                <div class="bill-price">
                                    ...
                                    <div class="bill-price-content">
                                        <div class="bill-price-row1">
                                            ...
                                            <span class="corange">
                                                 <span class="cfont18 bold" id="card_name"></span>
                                            </span>
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <div class="bill-price">
                                    ...
                                    <div class="bill-price-content">
                                        <div class="bill-price-row1"><span class="bill-price-main">
                                            ...
                                            <span class="cfont18 bold" id="amount2"></span>
                                                <input type="hidden" value="1684948436101" name="orderid" id="orderid">
                            ...
                            <script>
                                ...
                                function getOrderById() {
                                    ...
                                    var url = "/sub-api/api/getById?id=" + orderNos;
                                    $.ajax({
                                        url: url,
                                        type: 'get',
                                        async: false,
                                        success: function (data) {
                                            if (!data.success) {
                                                ...
                                                main2.style.cssText = "display:none;";
                                                window.open('https://www.baidu.com/', '_self');
                                            } else {
                                                if (data.data.isSub == true) {
                                                    var payStatus = data.data.payStatus
                                                    isTip = false
                                                    main.style.cssText = "display:none;";
                                                    main2.style.cssText = "display: block;";
                                                    if (payStatus == 2) {
                                                        $("#messageTip").html("回收成功");
                                                    } else if (payStatus == 3) {
                                                        $("#messageTip").html("回收失败");
                                                    } else {
                                                        $("#messageTip").html("回收中，请等待");
                                                    }
                                                    ...
                                                    cardNoLenth = data.data.cardNoLenth;
                                                    pwdNoLenth = data.data.pwdNoLenth;
                                                    type = data.data.type;
                                                    isTip = true
                                                    let amount = data.data.amount;
                                                    amount = getamount(amount)
                                                    $("#orderid").val(orderNos);
                                                    $("#amount").html(amount);
                                                    $("#amount2").html(amount);
                                                    $("#amount0").html(amount);
                                                    $("#orderNo").html(orderNos);
                                                    $("#card_name_title").html(cardName + amount + "元");
                                                    $("#card_name").html(cardName + amount + "元");
                                                    if (type == 'jd') {
                                                        kahao.style.cssText = "display:none;";
                                                    } else {
                                                        $("input[name=card_no]").attr("placeholder", "请输入" + cardName + "卡号");
                                                    }
                                                    $("input[name=card_pwd]").attr("placeholder", "请输入" + cardName + "卡密");
                                                    $("span[name=cardname]").html("”" + cardName + "“");
                                                    document.getElementById("c_payment_index_payBtn_douyin").href = data.data.dy;
                                                    document.getElementById("c_payment_index_payBtn_jd").href = data.data.jd;
                                                    document.getElementById("c_payment_index_payBtn_taobao").href = data.data.tb;
                                                    let jdShow = data.data.jdShow;
                                                    if (!jdShow) {
                                                        c_payment_index_payBtn_jd.style.cssText = "display:none;";
                                                    }
                                                    let dyShow = data.data.dyShow;
                                                    if (!dyShow) {
                                                        c_payment_index_payBtn_douyin.style.cssText = "display:none;";
                                                    }
                                                    let tbShow = data.data.tbShow;
                                                    if (!tbShow) {
                                                        c_payment_index_payBtn_taobao.style.cssText = "display:none;";
                                ...
                                function submit() {
                                    ...
                                    $.ajax({
                                        url: "/sub-api/system/merchantOrder/acceptCard",
                                        type: 'POST',
                                        async: false,
                                        dataType: 'json',
