<?php /*a:1:{s:78:"D:\phpStudy\PHPTutorial\WWW\hvvv\application\admin\view\orderdouyin\index.html";i:1651594359;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="getUrlTpl">
                {{#  if(d.weight == 0){ }}
                <button class="layui-btn layui-btn-primary layui-btn-xs">预拉停用</button>
                {{#  } else if(d.weight == 1) { }}
                <button class="layui-btn layui-btn-success layui-btn-xs">预拉开启</button>
                <!--                {{#  } else if(d.weight == 2) { }}-->
                <!--                <button class="layui-btn layui-btn-danger layui-btn-xs">已禁用</button>-->
                {{#  } }}
                <!--                <?php if((buttonAuth('torder/changestatus'))): ?>-->
