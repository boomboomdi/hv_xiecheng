<?php /*a:1:{s:73:"D:\phpStudy\PHPTutorial\WWW\dvpay\application\admin\view\login\index.html";i:1640234194;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <title>DV支付后台-<?php echo htmlentities($node_title); ?></title>
...
<div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: none;">
    ...
    <div class="layadmin-user-login-main" style="border: 1px solid #dddddd;background: #fff;padding: 20px;">
        <div class="layadmin-user-login-box layadmin-user-login-header">
            <h2>DV</h2>
            <p>DV<?php echo htmlentities($node_title); ?>后台</p>
        </div>
