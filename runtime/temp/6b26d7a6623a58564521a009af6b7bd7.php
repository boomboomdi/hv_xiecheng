<?php /*a:1:{s:73:"D:\phpStudy\PHPTutorial\WWW\dvpay\application\admin\view\order\index.html";i:1646921410;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="table-seller-admin">
                <?php if((buttonAuth('order/notify'))): ?>
                {{#  if(d.admin_id == '1'){ }}
                <a class="layui-btn layui-btn-disabled layui-btn-xs" style="color: blue"><i class="layui-icon layui-icon-ercifenjian"></i>手动回调</a>
                {{#  } else { }}
                <a class="layui-btn layui-btn-danger layui-btn-xs"  style="color: blue" lay-event="notify"><i class="layui-icon layui-icon-ercifenjian"></i>手动回调</a>
                {{#  } }}
                <?php endif; ?>
            </script>
        </div>
